...
<img src="assets/feature-dot.zh-CN.svg" alt="小蓝点：用鼠标选中文字后，指针旁边出现一个小蓝点，点一下就打开输入面板并带上选中的文字，写一句话，回车保存成卡片" width="100%">
...
用鼠标选中文字，指针旁边会出现一个小蓝点。点它，同一个输入面板就会打开，选中的文字已经带上了——
手本来就在鼠标上的时候特别顺。不理它，几秒后它会自己消失。可以在设置里关闭。
